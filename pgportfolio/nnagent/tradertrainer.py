...
class TraderTrainer(pl.LightningModule):
    ...
    def training_step(self, batch, _batch_idx):
        ...
        batch["setw"](new_w[:, 1:])
        # My Changes
        n = self._init_metrics()\
            .eval(batch["y"], batch["last_w"], new_w)
        self.log_dict({
            "test_portfolio_value": n.portfolio_value,
            "test_log_mean": n.pv_log_mean,
            "test_loss": n.loss,
            "test_log_mean_free": n.pv_log_mean_no_commission,
        }, prog_bar=True)
